...
echo "========================================"
echo "PACK LIMIT -- find max pack_length before OOM"
echo "$(date)"
echo "========================================"
...
# Test increasing pack lengths at L=128 until OOM
# 64K works fine, try 80K -> 96K -> 112K -> 128K
# Format: "label pack_length base_lookahead lookahead_step"
CONFIGS=(
    "pack160k_L128    163840 128 0"
    "pack192k_L128    196608 128 0"
    "pack224k_L128    229376 128 0"
    "pack256k_L128    262144 128 0"
)
...
echo ""
echo "PACK LIMIT BENCHMARK COMPLETE -- $(date)"
