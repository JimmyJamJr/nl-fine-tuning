#!/bin/bash
#SBATCH -J pretrain_pptrain_perseq_lr6e-4_3000steps_5pct_bs1024_warmup100
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --gres=gpu:8
...
#                    CONFIGURATION
# ==========================================================
# Mode 3: From pptrain checkpoint + x% synthetic mix
# All pretrain.py arguments are listed here for easy modification.
# ==========================================================

# Run configuration
RUN_NAME="pretrain_pptrain_perseq_lr6e-4_3000steps_5pct_bs1024_warmup100"
...
PPTRAIN_CHECKPOINT="/scratch/gautschi/mnickel/pptrain--lr1e-4/checkpoints/step_00237090"  # "latest" = auto-find latest pptrain checkpoint
...
echo "=========================================="
echo "PRETRAINING: $RUN_NAME (From pptrain + ${SYNTHETIC_PERCENT}% synthetic mix)"
echo "Run dir: $SCRATCH/$RUN_NAME"
echo "Data dir: $DATA_DIR"
echo "C4 dir: $C4_DIR"
echo "Model: $MODEL_NAME (from pptrain checkpoint: $PPTRAIN_CHECKPOINT)"
